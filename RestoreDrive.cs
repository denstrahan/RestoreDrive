/////////////////////////////////////////////////////////////////////////////////////////////
//// Module Name:  RestoreDrive.cs                                                       ////
//// Project:      Restore Drive Letter.                                                 ////
//// Purpose:      To reassign a drive letter that has been unexpectedly dropped.        ////
////                                                                                     ////
//// I created this quick and dirty app to handle a problem I keep having with a logical ////
//// drive I use to hold my data.  Every so often the drive letter gets dropped for      ////
//// no apparent reason.  I searched and searched for an easy solution but couldn't find ////
//// one so I decided to write my own.  It's not fancy but it works!  I set up a         ////
//// scheduled task for it to run at startup and every hour thereafter...                ////
/////////////////////////////////////////////////////////////////////////////////////////////
...
namespace RestoreDrive
{
    internal class RestoreDrive
    {
        ...
        private static bool RestoreDriveInit()
        {
            ...
            // No need to proceed further if the drive letter hasn't been dropped...
            ...
            // Make sure the messages reflect the "new" drive letter...
        ...
        /// <summary>
        /// ////////////////////////////////////////////////////////////////////
        /// This method uses the volume label to retrieve it's GUID,         ///
        /// which is used by the SetVolumeMountPoint Win32 API function...   ///
        /// ////////////////////////////////////////////////////////////////////
        /// </summary>
        private static void RestoreDriveLetter()
        {
            try
            {
                // Use Linq to query System.Management...
                ...
                { 
                    ...
                    {
                        EventLogger.Add(strFatalErrMsg + "call to SetVolumeMountPoint() failed for Volume Label = " + strVolLabel);
                    }
                }
        ...
        /// <summary>
        /// ///////////////////////////////////////////////////////////////////
        /// Create the start up log entry for the Event Log...              ///
        /// ///////////////////////////////////////////////////////////////////
        /// </summary>
        ...
        /// <summary>
        /// ////////////////////////////////////////////////////////////////////
        /// Create the final log entry for the Event Log...                  ///
        /// ////////////////////////////////////////////////////////////////////
        /// </summary>
